        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   ...
                   <li> <a href="medicine_user_request.php">Requested Medicine</a></li>
                   <li class="active">Medicine Information</li>
                </ul>
                <!-- END BREADCRUMB -->
...
<center> <label class=" control-label">Medicine Image</label></center>
                            ...
                            function fileValidation() {
                                ...
                                if (!allowedExtensions.exec(filePath)) {
                                    ...
                                    return false;
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" name="fld_medicine_name" class="form-control" readonly="" style="color: #555;" value="<?php echo $fld_medicine_name ?>"/>                                         
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                <input type="text" name="fld_medicine_quantity" class="form-control" readonly="" style="color: #555;"  value=" <?php echo $fld_medicine_quantity ?> "/>
                                    ...
                                    <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                                <input type="text" name="fld_medicine_expiry" class="form-control datepicker" readonly="" style="color: #555;" placeholder="ADD Expiry Date" value="<?php echo $fld_medicine_expiry ?>">                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                <input type="text" name="fld_medicine_company_name" class="form-control" readonly="" style="color: #555;" value=" <?php echo $fld_medicine_company_name ?> " />
