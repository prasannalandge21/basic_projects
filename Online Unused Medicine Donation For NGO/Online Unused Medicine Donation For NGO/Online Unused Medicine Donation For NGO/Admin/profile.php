        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>Admin Profile</h2>
                </div>
                <!-- END PAGE TITLE -->                
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                        <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_admin_name'] ;?>">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                       <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_admin_mobileno'] ;?>">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_admin_email'] ;?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                     <textarea disabled="" style="color: #555;" class="form-control" rows="5"><?php echo $fetch_user['fld_admin_address']  ;?> </textarea>
