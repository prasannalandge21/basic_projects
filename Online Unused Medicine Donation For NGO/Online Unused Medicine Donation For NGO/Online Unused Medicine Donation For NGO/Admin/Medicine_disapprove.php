...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>disapproved Medicine</title>            
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                   <li><a href="dashboard.php">dashboard</a></li>
                    ...
                    <li class="active">disapproved medicine</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-thumbs-down"></span> Disapproved medine</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <?php 
                $view=mysqli_query($connect,"select u.*, f.* from tbl_user u, tbl_medicine f where f.fld_user_id=u.fld_user_id and fld_medicine_status='disapproved' order by f.fld_medicine_id desc") or die(mysqli_error($connect));
