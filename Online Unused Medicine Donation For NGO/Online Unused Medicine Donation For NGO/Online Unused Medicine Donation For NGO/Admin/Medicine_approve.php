        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Approved medicine</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-thumbs-up"></span> Approved medine</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <?php 
                $view=mysqli_query($connect,"select u.*, f.* from tbl_user u, tbl_medicine f where f.fld_user_id=u.fld_user_id and fld_medicine_status='approved' order by f.fld_medicine_id desc") or die(mysqli_error($connect));
