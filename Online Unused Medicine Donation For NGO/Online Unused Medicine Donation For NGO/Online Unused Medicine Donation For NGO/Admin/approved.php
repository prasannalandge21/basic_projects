        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-thumbs-up"></span> Approved User</h2>
                </div>
                <!-- END PAGE TITLE -->                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <?php 
                $view=mysqli_query($connect,"select * from tbl_user where fld_user_status='approved' order by fld_user_id desc ") or die(mysqli_error($connect));
