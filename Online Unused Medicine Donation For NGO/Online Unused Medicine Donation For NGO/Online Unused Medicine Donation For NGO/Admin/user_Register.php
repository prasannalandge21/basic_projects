        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-list"></span> Register User</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <?php 
                $view=mysqli_query($connect,"select * from tbl_user order by fld_user_id desc ") or die(mysqli_error($connect));
 ...
 ?>
    ...
    <tr>
        ...
        <th scope="row"><!-- <a href="delete.php?a_id=<?php echo $fetch['user_id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure you wnat to delete')"><i class="fas fa-trash-alt"></i></a> -->
            ...
            <a  href="user_approved.php?a_id=<?php echo $fetch['fld_user_id'];?>" ><i style="color: green;size: 30px;" class="fas fa-thumbs-up"></i></a>

            <a href="user_disapproved.php?a_id=<?php echo $fetch['fld_user_id'];?>" ><i style="color: red;size: 30px;" class="fas fa-thumbs-down"></i></a></th>
