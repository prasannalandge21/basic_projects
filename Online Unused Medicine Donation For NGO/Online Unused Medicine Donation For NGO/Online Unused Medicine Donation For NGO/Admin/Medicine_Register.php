        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Register medicine</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-list"></span> Register medicine</h2>
                </div>
                <!-- END PAGE TITLE -->                
                ...
                <?php 
                $view=mysqli_query($connect,"select u.*, f.* from tbl_user u, tbl_medicine f where f.fld_user_id=u.fld_user_id order by f.fld_medicine_id desc") or die(mysqli_error($connect));
 ...
 ?>
    ...
    <tr>
        ...
        <th scope="row"><!-- <a href="delete.php?a_id=<?php echo $fetch['user_id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure you wnat to delete')"><i class="fas fa-trash-alt"></i></a> -->
            ...
            <a href="Medicine_approved.php?a_id=<?php echo $fetch['fld_medicine_id'];?>" ><i style="color: green;size: 30px;" class="fas fa-thumbs-up"></i></a>

            <a href="Medicine_disapproved.php?a_id=<?php echo $fetch['fld_medicine_id'];?>" ><i style="color: red;size: 30px;" class="fas fa-thumbs-down"></i></a></th>
