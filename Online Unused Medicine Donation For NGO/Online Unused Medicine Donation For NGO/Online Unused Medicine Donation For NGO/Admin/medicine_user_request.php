...
<head>        
    <!-- META SECTION -->
    <title>Requested medicine from user</title>            
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">                    
                <h2><span class="fa fa-mail-forward"></span> Request for medicine from user</h2>
            </div>
            <!-- END PAGE TITLE -->                
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php 
                        $view=mysqli_query($connect,"select * from tbl_medicine where fld_medicine_request='requested to admin For approvel' order by fld_medicine_id  desc ") or die(mysqli_error($connect));
...
<th scope="row"> 
   <a href="medicine_update1.php?fld_medicine_id=<?php echo $fetch['fld_medicine_id']; ?>"><i class="fas fa-eye fa-2x"></i></a>
          ...
          <?php }
           ...
           ?>
             ...
             <th scope="row"> <a href="medicine_accept.php?a_id=<?php echo $fetch['fld_medicine_id'];?>" ><i style="color: green;size: 30px;" class="fas fa-check-circle fa-2x"></i></a>
                                            &nbsp;&nbsp;
               <a href="medicine_cancle.php?a_id=<?php echo $fetch['fld_medicine_id'];?>" ><i style="color: red;size: 30px;" class="fas far fa-times-circle fa-2x"></i></a></th>
                                      </tr>
                              <?php } ?>
                                  </tbody>
                          </table>                                    
