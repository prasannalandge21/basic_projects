    ...
    <body>
        ...
        <div class="page-container">
           ...
           if(isset($_POST['submit']))
           {
            ...
            $asd="insert into tbl_feedback(fld_feedback_subject,fld_user_id,fld_feedback_discription)
            values('$fld_feedback_subject','".$_SESSION['id']."','$fld_feedback_discription')";
            ...
            else
            {
                echo "<script>";
                echo "alert('Error');";
                echo "window.location.href='feedback-view.php';";
                echo "</script>";
            }
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                 ...
                                 <a style="background-color: #1caf9a;color: white" href="Feedback_view.php"class="btn" >View</a>

                                 
                            </div>  
                                    <h3 class="panel-title"><strong>ADD Your valuable Feedback</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                <input type="text" name="fld_feedback_subject" class="form-control"/ required="">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Feedback</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" required="" name="fld_feedback_discription" rows="5"></textarea>
