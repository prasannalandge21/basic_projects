...
if(isset($_POST['submit']))
{
     ...
     $query = 'select * from tbl_user where  fld_user_password="'.$_POST['old_password'].'" and fld_user_email ="'.$_SESSION['user_email'].'" ';
        ...
        if(strlen($_POST['new_password']) >= 5 )
            {
                ...
                {
                    $query1='update tbl_user set fld_user_password="'.$_POST['new_password'].'" where fld_user_email ="'.$_SESSION['user_email'].'" ';   
