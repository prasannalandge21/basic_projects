                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Update Medicine Information</strong></h3>
...
$name=$_FILES['fld_medicine_img']['name'];
  ...
  if($name){
            ...
            unlink($upload.$fetch['fld_medicine_img']);
  ...
  else
  {
    ...
    $photo=$fetch['fld_medicine_img'];
  }
$update=mysqli_query($connect,"update tbl_medicine set 
 fld_medicine_img='".$photo."' ;
 

  where fld_medicine_id ='".$_SESSION['id']."'");

   $adsf="update tbl_medicine set 
           fld_medicine_name='".$fld_medicine_name."',
            fld_medicine_quantity='".$fld_medicine_quantity."',
            fld_medicine_expiry='".$fld_medicine_expiry."',
            fld_medicine_company_name='".$fld_medicine_company_name."',
             fld_medicine_descriptiom='".$fld_medicine_descriptiom."',
             fld_medicine_img='".$photo."'
            where fld_medicine_id='".$_GET['fld_medicine_id']."'";         
            ...
            {
                echo "<script>";
                echo "alert('medicine Information Updated');";
...
<div class="img_responsive">
       ...
       <center>  <div class="btn btn-danger btn-file"> <i class="glyphicon glyphicon-folder-open"></i> &nbsp;Browse … <input type="file" id="image" name="fld_medicine_img"></div></center> 




           <span class="help-block">Select Proper Image</span>
        </div>
                            ...
                            function fileValidation() {
                                ...
                                if (!allowedExtensions.exec(filePath)) {
                                    ...
                                    return false;
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" name="fld_medicine_name" class="form-control" value="<?php echo $fld_medicine_name ?>"/>                                         
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                <input type="text" name="fld_medicine_quantity" class="form-control"  value=" <?php echo $fld_medicine_quantity ?> "/>
                                    ...
                                    <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                                <input type="text" name="fld_medicine_expiry" class="form-control datepicker" placeholder="ADD Expiry Date" value="<?php echo $fld_medicine_expiry ?>">                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                                <input type="text" name="fld_medicine_company_name" class="form-control" value=" <?php echo $fld_medicine_company_name ?> " />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="fld_medicine_descriptiom" rows="5"><?php echo $fld_medicine_descriptiom; ?></textarea>
