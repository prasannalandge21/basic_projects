                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                        <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_user_name'] ;?>">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                       <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_user_mobileno'] ;?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">         
                                                 <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_user_city'] ;?>">   
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" readonly="" style="color: #555;" value="<?php echo $fetch_user['fld_user_email'] ;?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                     <textarea disabled="" style="color: #555;" class="form-control" rows="5"><?php echo $fetch_user['fld_user_address']  ;?> </textarea>
