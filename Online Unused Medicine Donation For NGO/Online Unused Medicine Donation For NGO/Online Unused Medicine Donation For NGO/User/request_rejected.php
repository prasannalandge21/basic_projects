...
<head>        
    <!-- META SECTION -->
    <title>Request rejected medicine</title>            
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Request rejected</li>
            </ul>
            <!-- END BREADCRUMB -->
            
            <!-- PAGE TITLE -->
            <div class="page-title">                    
                <h2><span class="fa fa-times"></span> Rejected Request for medicine</h2>
            </div>
            <!-- END PAGE TITLE -->                
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php 
                        $view=mysqli_query($connect,"select * from tbl_medicine where fld_medicine_request='request cancle by user' and fld_user_id='".$_SESSION['id']."' order by fld_medicine_id  desc ") or die(mysqli_error($connect));
