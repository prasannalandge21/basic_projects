    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Sold Out Medicine</li>
            </ul>
            <!-- END BREADCRUMB -->
            
            <!-- PAGE TITLE -->
            <div class="page-title">                    
                <h2><span class="fa fa-times-circle"></span> Sold Out Medicine</h2>
            </div>
            <!-- END PAGE TITLE -->                
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php 
                        $view=mysqli_query($connect,"select * from tbl_medicine where fld_medicine_request='Medicine Sold Out' and fld_user_id='".$_SESSION['id']."' order by fld_medicine_id  desc ") or die(mysqli_error($connect));
